...
// GitsecRepository is an auto generated low-level Go binding around an user-defined struct.
type GitsecRepository struct {
	Id          *big.Int
	Name        string
	Description string
...
func (_Contract *ContractCaller) GetAllRepositories(opts *bind.CallOpts) ([]GitsecRepository, error) {
	...
	if err != nil {
		return *new([]GitsecRepository), err
	}

	out0 := *abi.ConvertType(out[0], new([]GitsecRepository)).(*[]GitsecRepository)
...
// CreateRepository is a paid mutator transaction binding the contract method 0xc2692760.
//
// Solidity: function createRepository(string name, string description) returns(uint256)
func (_Contract *ContractTransactor) CreateRepository(opts *bind.TransactOpts, name string, description string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "createRepository", name, description)
}

// CreateRepository is a paid mutator transaction binding the contract method 0xc2692760.
//
// Solidity: function createRepository(string name, string description) returns(uint256)
func (_Contract *ContractSession) CreateRepository(name string, description string) (*types.Transaction, error) {
	return _Contract.Contract.CreateRepository(&_Contract.TransactOpts, name, description)
}

// CreateRepository is a paid mutator transaction binding the contract method 0xc2692760.
//
// Solidity: function createRepository(string name, string description) returns(uint256)
func (_Contract *ContractTransactorSession) CreateRepository(name string, description string) (*types.Transaction, error) {
	return _Contract.Contract.CreateRepository(&_Contract.TransactOpts, name, description)
}

// DeleteRepository is a paid mutator transaction binding the contract method 0x92e41c6e.
//
// Solidity: function deleteRepository(uint256 id) returns()
func (_Contract *ContractTransactor) DeleteRepository(opts *bind.TransactOpts, id *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "deleteRepository", id)
}

// DeleteRepository is a paid mutator transaction binding the contract method 0x92e41c6e.
//
// Solidity: function deleteRepository(uint256 id) returns()
func (_Contract *ContractSession) DeleteRepository(id *big.Int) (*types.Transaction, error) {
...
func (_Contract *ContractTransactor) SetAdmin(opts *bind.TransactOpts, newAdmin common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setAdmin", newAdmin)
}

// SetAdmin is a paid mutator transaction binding the contract method 0x704b6c02.
//
// Solidity: function setAdmin(address newAdmin) returns()
func (_Contract *ContractSession) SetAdmin(newAdmin common.Address) (*types.Transaction, error) {
	return _Contract.Contract.SetAdmin(&_Contract.TransactOpts, newAdmin)
}

// SetAdmin is a paid mutator transaction binding the contract method 0x704b6c02.
//
// Solidity: function setAdmin(address newAdmin) returns()
func (_Contract *ContractTransactorSession) SetAdmin(newAdmin common.Address) (*types.Transaction, error) {
	return _Contract.Contract.SetAdmin(&_Contract.TransactOpts, newAdmin)
}
...
// UpdateDescription is a paid mutator transaction binding the contract method 0x14dee4b3.
//
// Solidity: function updateDescription(uint256 id, string newDescription) returns()
func (_Contract *ContractTransactor) UpdateDescription(opts *bind.TransactOpts, id *big.Int, newDescription string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "updateDescription", id, newDescription)
}

// UpdateDescription is a paid mutator transaction binding the contract method 0x14dee4b3.
//
// Solidity: function updateDescription(uint256 id, string newDescription) returns()
func (_Contract *ContractSession) UpdateDescription(id *big.Int, newDescription string) (*types.Transaction, error) {
	return _Contract.Contract.UpdateDescription(&_Contract.TransactOpts, id, newDescription)
}

// UpdateDescription is a paid mutator transaction binding the contract method 0x14dee4b3.
//
// Solidity: function updateDescription(uint256 id, string newDescription) returns()
func (_Contract *ContractTransactorSession) UpdateDescription(id *big.Int, newDescription string) (*types.Transaction, error) {
	return _Contract.Contract.UpdateDescription(&_Contract.TransactOpts, id, newDescription)
}

// UpdateIPFS is a paid mutator transaction binding the contract method 0x30d8bb9b.
//
// Solidity: function updateIPFS(uint256 id, string newIPFS) returns()
func (_Contract *ContractTransactor) UpdateIPFS(opts *bind.TransactOpts, id *big.Int, newIPFS string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "updateIPFS", id, newIPFS)
}

// UpdateIPFS is a paid mutator transaction binding the contract method 0x30d8bb9b.
//
// Solidity: function updateIPFS(uint256 id, string newIPFS) returns()
func (_Contract *ContractSession) UpdateIPFS(id *big.Int, newIPFS string) (*types.Transaction, error) {
	return _Contract.Contract.UpdateIPFS(&_Contract.TransactOpts, id, newIPFS)
}

// UpdateIPFS is a paid mutator transaction binding the contract method 0x30d8bb9b.
//
// Solidity: function updateIPFS(uint256 id, string newIPFS) returns()
func (_Contract *ContractTransactorSession) UpdateIPFS(id *big.Int, newIPFS string) (*types.Transaction, error) {
	return _Contract.Contract.UpdateIPFS(&_Contract.TransactOpts, id, newIPFS)
}
...
// ContractIPFSHashUpdatedIterator is returned from FilterIPFSHashUpdated and is used to iterate over the raw logs and unpacked data for IPFSHashUpdated events raised by the Contract contract.
type ContractIPFSHashUpdatedIterator struct {
	Event *ContractIPFSHashUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractIPFSHashUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractIPFSHashUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractIPFSHashUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractIPFSHashUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractIPFSHashUpdated represents a IPFSHashUpdated event raised by the Contract contract.
type ContractIPFSHashUpdated struct {
	RepId *big.Int
	Owner common.Address
	IPFS  string
	Raw   types.Log // Blockchain specific contextual infos
...
// FilterIPFSHashUpdated is a free log retrieval operation binding the contract event 0x40a9418af964c87768383b4b3aebe2d80f69c88cb618bbf0d194a1bf203e4e89.
//
// Solidity: event IPFSHashUpdated(uint256 indexed repId, address indexed owner, string IPFS)
func (_Contract *ContractFilterer) FilterIPFSHashUpdated(opts *bind.FilterOpts, repId []*big.Int, owner []common.Address) (*ContractIPFSHashUpdatedIterator, error) {

	var repIdRule []interface{}
	for _, repIdItem := range repId {
		repIdRule = append(repIdRule, repIdItem)
	}
	var ownerRule []interface{}
	for _, ownerItem := range owner {
		ownerRule = append(ownerRule, ownerItem)
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "IPFSHashUpdated", repIdRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return &ContractIPFSHashUpdatedIterator{contract: _Contract.contract, event: "IPFSHashUpdated", logs: logs, sub: sub}, nil
}

// WatchIPFSHashUpdated is a free log subscription operation binding the contract event 0x40a9418af964c87768383b4b3aebe2d80f69c88cb618bbf0d194a1bf203e4e89.
//
// Solidity: event IPFSHashUpdated(uint256 indexed repId, address indexed owner, string IPFS)
func (_Contract *ContractFilterer) WatchIPFSHashUpdated(opts *bind.WatchOpts, sink chan<- *ContractIPFSHashUpdated, repId []*big.Int, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "IPFSHashUpdated", repIdRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractIPFSHashUpdated)
				if err := _Contract.contract.UnpackLog(event, "IPFSHashUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseIPFSHashUpdated is a log parse operation binding the contract event 0x40a9418af964c87768383b4b3aebe2d80f69c88cb618bbf0d194a1bf203e4e89.
//
// Solidity: event IPFSHashUpdated(uint256 indexed repId, address indexed owner, string IPFS)
func (_Contract *ContractFilterer) ParseIPFSHashUpdated(log types.Log) (*ContractIPFSHashUpdated, error) {
	event := new(ContractIPFSHashUpdated)
	if err := _Contract.contract.UnpackLog(event, "IPFSHashUpdated", log); err != nil {
		return nil, err
	}
...
// ContractRepositoryCreatedIterator is returned from FilterRepositoryCreated and is used to iterate over the raw logs and unpacked data for RepositoryCreated events raised by the Contract contract.
type ContractRepositoryCreatedIterator struct {
	Event *ContractRepositoryCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractRepositoryCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractRepositoryCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractRepositoryCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractRepositoryCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
